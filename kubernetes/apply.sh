...
multipass exec worker1 -- sudo mkdir -p /data/postgres /data/redis /apps/logs
multipass exec worker2 -- sudo mkdir -p /data/ollama /apps/logs
...
echo "Pulling model..."
kubectl exec -n auth deployment/ollama -- ollama pull qwen2.5:1.5b
